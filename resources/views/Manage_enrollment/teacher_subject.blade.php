...
<div id="printableReport" class="container-fluid">
    ...
    <div class="card shadow-sm mb-4 border-0">
        <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fa fa-chalkboard-teacher me-2"></i> Assign Teacher Subjects</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('student_subject_save') }}" method="POST" class="row g-3">
                @csrf
                <div class="col-md-4">
                    <label for="teacher" class="form-label">Select Teacher <span class="text-danger">*</span></label>
                    <select name="teacher" class="form-select select2" required>
                        <option value=""></option>
                        @foreach($U as $row)
                ...
                <div class="col-md-4">
                    ...
                    <select name="subject" class="form-select select2" required>
                        <option value=""></option>
                        @foreach($S as $row)
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fa fa-list-alt me-2 text-primary"></i> Assigned Teacher Subjects</h5>
        </div>
        <div class="card-body">
                ...
                <table id="example" class="table table-hover align-middle">
                    <thead class="table-primary">
                        <tr>
                            ...
                            <th><i class="fa fa-book me-1"></i> Subject</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Are you sure you want to remove this subject assignment?');" method="POST" action="{{ route('de_enroll') }}">
                                    @csrf
